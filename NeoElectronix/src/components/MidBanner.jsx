...
const MidBanner = () => {
  return (
    <div className='bg-[#eae4d5] dark:bg-[#060509] md:py-24'>
      <div className='relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover bg-center h-[550px] md:h-[600px] ' style={{backgroundImage: `url(${banner})`, backgroundPosition:'center', backgroundAttachment: 'fixed'}}>
        <div className='absolute inset-0 bg-black/60 md:rounded-2xl bg-opacity-50 flex items-center justify-center'>
            <div className='text-center text-white px-4'>
                ...
                <button className='dark:bg-[#169976] hover:dark:bg-[#1dcd9f] hover:dark:text-[#000] bg-[#fe7743] text-[#273f4f] hover:bg-[#273f4f] hover:text-[#fe7743] font-bold py-2 px-4 md:py-3 md:px-6 rounded-lg transition duration-300'>Shop Now</button>
            </div>
        </div>
      </div>
    </div>
